...
use tradingview_websocket_client::{DefaultTradingViewMessageProcessor, TradingViewClient, TradingViewClientConfig, TradingViewMessageProcessor};
...
async fn post_scrape(executor: Arc<Executor<'static>>, request: Request<Vec<u8>>) -> anyhow::Result<Response<String>> {
